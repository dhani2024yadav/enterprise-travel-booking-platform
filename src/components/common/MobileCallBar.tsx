  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-white border-t border-gray-200 shadow-[0_-4px_20px_rgba(0,0,0,0.1)]">
      <div className="grid grid-cols-2 gap-0">
        <a
          href="tel:8953131595"
          className="flex items-center justify-center gap-2 py-3.5 bg-navy-950 text-white font-semibold text-sm"
        >
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 py-3.5 bg-green-500 text-white font-semibold text-sm"
        >
